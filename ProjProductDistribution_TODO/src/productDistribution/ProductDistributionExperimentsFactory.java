...
public class ProductDistributionExperimentsFactory extends ExperimentsFactory {

    private int populationSize;
    private int maxGenerations;
    private SelectionMethod<ProductDistributionIndividual, ProductDistributionProblem> selection;
    private Recombination<ProductDistributionIndividual, ProductDistributionProblem> recombination;
    private Mutation<ProductDistributionIndividual, ProductDistributionProblem> mutation;
    private ProductDistributionProblem problem;
    private Experiment<ProductDistributionExperimentsFactory, ProductDistributionProblem> experiment;

    public ProductDistributionExperimentsFactory(File configFile) throws IOException {
        super(configFile);
    }
    ...
    public Experiment buildExperiment() throws IOException {
        ...
        //PROBLEM
        problem = ProductDistributionProblem.buildWarehouse(new File(getParameterValue("Problem_file")));
    ...
    public GeneticAlgorithm generateGAInstance(int seed) {
        GeneticAlgorithm<ProductDistributionIndividual, ProductDistributionProblem> ga;
